...
<div style="display: none" id="addAndEditModel">
    ...
    <form class="layui-form layui-form-pane" action="" lay-filter="addUserFrame" id="addUserFrame" style="margin: 20px">
        ...
        <!-- 系统管理员类型标记 -->
        <input type="hidden" name="userMark" id="userMark">

        <div class="layui-form-item">
            <label class="layui-form-label">昵称</label>
            <div class="layui-input-block">
                <input type="text" name="userName" autocomplete="off" lay-verify="required" class="layui-input" placeholder="请输入真实姓名">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            <label class="layui-form-label">手机号</label>
            <div class="layui-input-block">
                <input type="text" name="userPhone" id="userPhone" autocomplete="off" lay-verify="required|phone|userPhone" class="layui-input" placeholder="请输入手机号码">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                ...
                <input type="text" name="userAccount" id="userAccount" autocomplete="off" lay-verify="required" class="layui-input" placeholder="请输入管理员账户名">
            </div>
        </div>
            ...
            , cols: [[
                ...
                , {
                    field: 'userType', title: '类型', align: "center", templet: function (typeData) {
                        return typeData.userType == '1' ? '<font color="red">系统管理员</font>' : '<font color="blue">普通用户</font>';
                    }
                }
